...
public class Tienda extends JFrame implements ActionListener {
	 ...
	 * if(MiTxt.getText().length()==10){ e.consume(); } }
	 */

	public static void imprimirListas(JTextArea txtS, String cod, String mod, double pre, double an, double al,
			double fon) {
	...
	public static void SetDatos(JTextField textModelo, JTextField textPrecio, JTextField textAncho, JTextField textAlto,
			JTextField textFondo, String mod, double pre, double an, double al, double fon) {
	...
	public static void getDatos(JTextField textModelo, JTextField textPrecio, JTextField textAncho, JTextField textAlto,
			JTextField textFondo, String mod, double pre, double an, double al, double fon) {
		mod = textModelo.getText();
		pre = Tienda.getDouble(textPrecio);
		an = Tienda.getDouble(textAncho);
		al = Tienda.getDouble(textAlto);
		fon = Tienda.getDouble(textFondo);
	}
	...
	public static Double numMayor(double may, double TVar0, double TVar01, double TVar02, double TVar03,
			double TVar04) {
	...
	public static boolean validarPor(double p, JTextField txt) {
		if (p > 100) {
			Tienda.mensaje(txt, "Los descuentos deben ser menores al 100%");
			txt.setText("");
			Tienda.focusSelectAll(txt);
			return false;
		}
		if (0 > p) {
			Tienda.mensaje(txt, "Los descuentos deben ser positivos");
			txt.setText("");
			Tienda.focusSelectAll(txt);
			return false;
		}else{
